 ...
 * @since 1.6 (Feb 21, 2016)
 */
public class IntTreeSortV1 {
    ...
    public static void sort(int[] array, int fromIndex, int toIndex) {
        ...
        new IntTreeSortV1(array, fromIndex, toIndex).sort();
    }
    ...
    private IntTreeSortV1(int[] array, int fromIndex, int toIndex) {
        this.array     = array;
